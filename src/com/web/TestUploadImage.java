...
public class TestUploadImage implements Controller {
			...
			try {
				...
				for (FileItem item : multiparts) {
					...
					if (!item.isFormField()) {
						...
						if("image/jpeg".equals(contentType))subFileName = "rmvb";
						if("image/png".equals(contentType))subFileName  = "flv";
						if(contentType.endsWith("mp4")) subFileName  = "mp4";
						if(contentType.endsWith("swf")) subFileName  = "swf";
